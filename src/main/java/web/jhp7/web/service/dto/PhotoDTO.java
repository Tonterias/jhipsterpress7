...
//    private Calbum calbum;
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((albumUserId == null) ? 0 : albumUserId.hashCode());
		result = prime * result + ((cAlbumUserId == null) ? 0 : cAlbumUserId.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (albumUserId == null) {
			if (other.albumUserId != null)
				return false;
		} else if (!albumUserId.equals(other.albumUserId))
			return false;
		if (cAlbumUserId == null) {
			if (other.cAlbumUserId != null)
				return false;
		} else if (!cAlbumUserId.equals(other.cAlbumUserId))
			return false;
	...
	public String toString() {
		return "PhotoDTO [id=" + id + ", creationDate=" + creationDate + ", image=" + Arrays.toString(image)
				+ ", imageContentType=" + imageContentType + ", albumUserId=" + albumUserId + ", cAlbumUserId="
				+ cAlbumUserId + "]";
	}
